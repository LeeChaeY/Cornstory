            ...
            <div class="contents-form" >
                <div class="container-md">
                    ...
                    <div class="inputset inputset-lg inputset-group">
                        ...
                        <input type="text" class="inputset-input form-control" id="workName" name="workName" maxlength="30">
                    ...
                    <div class="inputset inputset-lg inputset-group" style="line-height: 10;">
                        ...
                        <div class="checkset-wrap">
                            <!-- 학원 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreAcademy" class="checkset-input input-fill"type="checkbox" name="genre" value="학원">
                                <label class="checkset-label" for="genreAcademy"></label>
                                <span class="checkset-text">학원</span>
                            </div>
                            <!-- 액션 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreAction" class="checkset-input input-fill" type="checkbox" name="genre" value="액션">
                                <label class="checkset-label" for="genreAction"></label>
                                <span class="checkset-text">액션</span>
                            </div>
                            <!-- SF 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreSF" class="checkset-input input-fill" type="checkbox" name="genre" value="SF">
                                <label class="checkset-label" for="genreSF"></label>
                                <span class="checkset-text">SF</span>
                            </div>
                            <!-- 판타지 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreFantasy" class="checkset-input input-fill" type="checkbox" name="genre" value="판타지">
                                <label class="checkset-label" for="genreFantasy"></label>
                                <span class="checkset-text">판타지</span>
                            </div>
                            <!-- 개그 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreComedy" class="checkset-input input-fill" type="checkbox" name="genre" value="개그">
                                <label class="checkset-label" for="genreComedy"></label>
                                <span class="checkset-text">개그</span>
                            </div>
                            <!-- 로맨스 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreRomance" class="checkset-input input-fill" type="checkbox" name="genre" value="로맨스">
                                <label class="checkset-label" for="genreRomance"></label>
                                <span class="checkset-text">로맨스</span>
                            </div>
                            <!-- 스포츠 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreSports" class="checkset-input input-fill" type="checkbox" name="genre" value="스포츠">
                                <label class="checkset-label" for="genreSports"></label>
                                <span class="checkset-text">스포츠</span>
                            </div>
                            <!-- 일상 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreSliceOfLife" class="checkset-input input-fill" type="checkbox" name="genre" value="일상">
                                <label class="checkset-label" for="genreSliceOfLife"></label>
                                <span class="checkset-text">일상</span>
                            </div>
                            <!-- 추리 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreMystery" class="checkset-input input-fill" type="checkbox" name="genre" value="추리">
                                <label class="checkset-label" for="genreMystery"></label>
                                <span class="checkset-text">추리</span>
                            </div>
                            <!-- 스릴러 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreThriller" class="checkset-input input-fill" type="checkbox" name="genre" value="스릴러">
                                <label class="checkset-label" for="genreThriller"></label>
                                <span class="checkset-text">스릴러</span>
                            </div>
                            <!-- 무협 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreMartialArts" class="checkset-input input-fill" type="checkbox" name="genre" value="무협">
                                <label class="checkset-label" for="genreMartialArts"></label>
                                <span class="checkset-text">무협</span>
                            </div>
                            <!-- 기타 장르 체크박스 -->
                            <div class="checkset">
                                <input id="genreOthers" class="checkset-input input-fill" type="checkbox" name="genre" value="기타">
