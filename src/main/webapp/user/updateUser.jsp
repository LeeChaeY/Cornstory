                        ...
                        <div class="contents-form-bottom">
                            ...
                            <div class="inputset inputset-lg inputset-label" >
                                <label >
                                   ...
                                   ${user.userId}
                                    ...
                                    <input type="hidden" name="rDate" value="${user.rDate}">
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label  for="password">
                                    ...
                                    <input type="password" class="inputset-input form-control" value="${user.password}" id="password" name="password"
                            ...
                            <div class="inputset inputset-lg inputset-label" >
                                <label for="nickName">
                                    ...
                                    <input type="text" class="inputset-input form-control" value="${user.nickName}" id="nickName" name="nickName"
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label  for="birthday">
                                    ...
                                    <input type="date" class="inputset-input form-control"  value="${user.birthday}" id="birthday" name="birthday" max="2024-12-31" required>
                                </label>
                            </div>
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label for="addr">
                                    ...
                                    <input type="text" class="inputset-input form-control" value="${user.addr}" id="addr" name="addr" required>
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label for="address">
                                    ...
                                    <input type="text" class="inputset-input form-control" value="${user.address}" id="address" name="address" required>
                                </label>
                            </div>
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label for="phone">
                                    ...
                                    <input type="tel" class="inputset-input form-control" value="${user.phone}" id="phone" name="phone" required>
                                </label>
                            </div>
                            ...
                            <div class="inputset inputset-lg inputset-label">
                                <label  for="email">
                                    ...
                                    <input type="email" class="inputset-input form-control" id="email" value="${user.email}" name="email" value="${kakaoUserInfo.email}"required>
                                </label>
                            </div>
                            ...
                            <div class="inputset inputset-lg inputset-label"  for="userImage">
                                <label>
                                    ...
                                    <div style="text-align: Left;">
                                        <img src="../file/user/${user.userImage}" width="80" style="border-radius: 50%; max-width: 100%;" alt=""/>
                                        <p class="check-stext">* 기존 이미지 입니다.</p>
                                    </div>
                                </label>
...
<script src="../user/js/updateUser.js"></script>
