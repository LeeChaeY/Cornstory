        ...
        <div class="contents-inner">
            <div class="contents-container container-md">
                <div class="textset textset-h2">
                    <h2 class="textset-tit">스토리 등록</h2>
                </div>
                <form action="../story/addStory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="contents-form">
                        <div class="contents-form-middle">
                            <div class="inputset inputset-lg inputset-label">
                                <label>
                                    ...
                                    <input type="text" class="inputset-input form-control" placeholder="스토리 이름을 입력해주세요." id="storyName" name="storyName" required="">
                                </label>
                            </div>
                            <div class="inputset inputset-lg inputset-label">
                                <label>
                                    <h6 class="inputset-tit">스토리 내용</h6>
                                    <textarea class="inputset-textarea" placeholder="스토리 내용을 입력해주세요." id="storyContent" name="storyContent" required></textarea>
                        ...
                        <div class="contents-sign">
                            <button class="btnset modalset-btn">등록</button>
