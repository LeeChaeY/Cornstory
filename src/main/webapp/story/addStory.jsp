            ...
            <div class="contents-form container-md">
                ...
                <form action="/story/addStory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="storyContent" name="storyContent" rows="4" required></textarea>
                    </div>
...
<%--    <input type="hidden" name="userId" value="${user.userId}"/>--%>
<%--    <label for="storyName">스토리 :</label>--%>
<%--    <input name="storyName" id="storyName" required/><br/>--%>

<%--    <label for="storyContent">Story Content:</label>--%>
<%--    <textarea name="storyContent" id="storyContent" required></textarea><br/>--%>
